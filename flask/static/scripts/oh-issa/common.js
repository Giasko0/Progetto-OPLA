/**
 * Script comune per le pagine OH-ISSA
 * Gestisce funzionalità condivise tra le pagine dell'applicazione OH-ISSA
 */
document.addEventListener('DOMContentLoaded', function() {
    // La funzione setActiveNavItem è stata rimossa
});

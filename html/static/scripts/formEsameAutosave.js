  ...
  const FormEsameAutosave = (function() {
    ...
    function autoSaveLastModifiedSection() {
      ...
      const formData = {
        ...
        durata_h: sectionToSave.querySelector('[id^="durata_h_"]').value,
        durata_m: sectionToSave.querySelector('[id^="durata_m_"]').value,
        ...
        verbalizzazione: sectionToSave.querySelector('[id^="verbalizzazione_"]').value,
        tipoEsame: sectionToSave.querySelector('[id^="tipoEsame_"]').value,
        note: sectionToSave.querySelector('[id^="note_"]').value,
        mostra_nel_calendario: sectionToSave.querySelector('[id^="mostra_nel_calendario_"]').checked,
        tipo_appello_radio: sectionToSave.querySelector('input[name^="tipo_appello_radio_"]:checked').value,
    ...
    function precompileNewSection(newSection, excludeFromReferenceSection = []) {
      ...
      const dataToClone = {
        ...
        durata_h: referenceSection.querySelector('[id^="durata_h_"]').value,
        durata_m: referenceSection.querySelector('[id^="durata_m_"]').value,
        ...
        verbalizzazione: referenceSection.querySelector('[id^="verbalizzazione_"]').value,
        ...
        mostra_nel_calendario: referenceSection.querySelector('[id^="mostra_nel_calendario_"]').checked,
        tipo_appello_radio: referenceSection.querySelector('input[name^="tipo_appello_radio_"]:checked').value
      };

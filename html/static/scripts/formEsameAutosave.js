    ...
    try {
      ...
      if (data.tipo_appello_radio) {
        ...
        if (sectionCounter) {
          ...
          if (radio) {
            radio.checked = true;
            // Trigger change event per aggiornare verbalizzazione
            radio.dispatchEvent(new Event('change', { bubbles: true }));
            
            // Assicurati che la verbalizzazione sia aggiornata dopo il trigger
            setTimeout(() => {
              ...
              // Reimposta il valore della verbalizzazione se era stato salvato
              if (data.verbalizzazione) {
                const verbalizzazione = section.querySelector('[id^="verbalizzazione_"]');
                if (verbalizzazione) verbalizzazione.value = data.verbalizzazione;
              }
